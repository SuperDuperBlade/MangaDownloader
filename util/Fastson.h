...
public:
	...
	static std::string fastSearchValue_fromFirst(std::string json, std::string parentKey) {
	...
	static std::vector<std::string> splitString(std::string token, std::string key) {
